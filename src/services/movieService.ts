...
const mockMovies: Movie[] = [
  ...
  { id: 13, title: "Top Gun: Maverick", poster_path: "https://images.pexels.com/photos/7991789/pexels-photo-7991789.jpeg?auto=compress&cs=tinysrgb&w=400", backdrop_path: "https://images.pexels.com/photos/7991789/pexels-photo-7991789.jpeg?auto=compress&cs=tinysrgb&w=1200", overview: "After thirty years, Maverick is still pushing the envelope as a top naval aviator, but must confront ghosts of his past when he leads TOP GUN's elite graduates on a mission.", release_date: "2022-05-27", vote_average: 8.3, vote_count: 16000, genre_ids: [28, 18] },
];
